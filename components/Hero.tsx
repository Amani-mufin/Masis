...
const HeroSection: React.FC = () => {
  return (
    <section className="flex flex-col gap-8 items-center mx-auto max-w-[1091px]">
      ...
      <p className="text-xl font-medium text-center max-w-[800px] text-zinc-200 max-md:text-lg max-sm:text-base">
